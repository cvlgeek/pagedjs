...
function parseDoc(){
  var a = `
    ...
    <script src='https://cvlgeek.github.io/pagedjs/scripts/paged.polyfill.js'>
    </script><link href='https://cvlgeek.github.io/pagedjs/styles/paged.css' rel='stylesheet' type='text/css'/></head><body>
  `
